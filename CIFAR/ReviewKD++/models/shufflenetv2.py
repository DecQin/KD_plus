...
class ShuffleNetV2(nn.Module):
    def __init__(self, net_size, num_class=10):
        ...
        self.linear = nn.Linear(out_channels[3], num_class)
        self.to('cuda')
    ...
    def forward(self, x, is_feat=False, preact=False):
        ...
        if is_feat:
            if preact:
                return [f0, f1_pre, f2_pre, f3_pre, f4], out, out1
            else:
                return [f0, f1, f2, f3, f4], out, out1
        else:
            return out1
...
if __name__ == '__main__':
    net = shufflev2_cifar(num_classes=100)
